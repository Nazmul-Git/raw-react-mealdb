...
const MealDetails = () => {
    ...
    const {idMeal, strMeal, strIngredient1, strIngredient2, strIngredient3, strIngredient4, strIngredient5, strIngredient6, strInstructions, strMealThumb, strMeasure1, strMeasure2, strTags } = details.meals[0];
    ...
    return (
        <div className='m-20'>
            ...
            <img className='ml-96 mt-24 mb-24 rounded-full' src={strMealThumb} alt="" />
            ...
            <div className='mt-12 flex justify-end gap-32'>
                ...
                <Link to={`mealId/${idMeal}`} className='bg-green-700 text-xl text-white font-bold pl-8 pr-8 rounded-md shadow-lg shadow-slate-950'>Order</Link>
            </div>
        </div>
    );
};
